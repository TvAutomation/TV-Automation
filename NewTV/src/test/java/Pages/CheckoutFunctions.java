...
public class CheckoutFunctions {
	...
	public CheckoutFunctions(WebDriver driver) {
	  ...
	  public void Add_Data(String FName,String LName,String Phone,String Company,String Adress,String ZipCode,String city) throws InterruptedException
	  {
	...
	public void CC_Payment_Method() throws InterruptedException {
		...
		// checkout_driver.findElement(By.xpath("//input[@type='text']")).sendKeys("4111
		// 1111 1111 1111");
